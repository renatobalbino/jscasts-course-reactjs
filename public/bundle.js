...
/***/ function(module, exports, __webpack_require__) {
	...
	// components
	var GitHubSearchUser = __webpack_require__(169);
	var GitHubUserInfo = __webpack_require__(191);
	...
	var Application = React.createClass({
		...
		render: function () {
			return React.createElement(
				'div',
				{ className: 'container' },
				React.createElement(GitHubSearchUser, {
					updateUser: this.updateUser,
					updateRepos: this.updateRepos }),
				React.createElement(GitHubUserInfo, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var GitHubUserService = __webpack_require__(190);

	var GitHubSearchUser = React.createClass({
		displayName: 'GitHubSearchUser',
		...
		handleSubmit: function (e) {
			...
			GitHubUserService.getByUsername(this.refs.username.value).then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GitHubUserRepos = __webpack_require__(192);
	...
	function GitHubUserInfo(props) {
		var userInfo = props.user ? React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'col-lg-8' },
				React.createElement(GitHubUserRepos, { repos: props.repos })
			)
		) : null;
